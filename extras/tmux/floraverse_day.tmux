...
set -g status-right "#[fg=#e6e4e6,bg=#e6e4e6,nobold,nounderscore,noitalics]#[fg=#368eb4,bg=#e6e4e6] #{prefix_highlight} #[fg=#bcbac1,bg=#e6e4e6,nobold,nounderscore,noitalics]#[fg=#368eb4,bg=#bcbac1] %Y-%m-%d  %I:%M %p #[fg=#368eb4,bg=#bcbac1,nobold,nounderscore,noitalics]#[fg=#f4f3f6,bg=#368eb4,bold] #h "
if-shell '[ "$(tmux show-option -gqv "clock-mode-style")" == "24" ]' {
  set -g status-right "#[fg=#e6e4e6,bg=#e6e4e6,nobold,nounderscore,noitalics]#[fg=#368eb4,bg=#e6e4e6] #{prefix_highlight} #[fg=#bcbac1,bg=#e6e4e6,nobold,nounderscore,noitalics]#[fg=#368eb4,bg=#bcbac1] %Y-%m-%d  %H:%M #[fg=#368eb4,bg=#bcbac1,nobold,nounderscore,noitalics]#[fg=#f4f3f6,bg=#368eb4,bold] #h "
}
